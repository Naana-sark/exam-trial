            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="individualform.php" class="btn btn-info pull-right" target="_blank">Add New Case</a>
                    </div>
                    <?php
                    //check connection
                            ...
                            echo "<table class='table table-bordered table-striped table-responsive-lg'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        ...
                                        echo "<th> Case ID</th>";
                                        echo "<th>Case Verdict</th>";
                                        echo "<th>Court Procedures</th>";
                                        echo "<th>Action</th>";
                                    echo "</tr>";
                                echo "</thead>";
                                echo "<tbody>";
                                while($row = $result->fetch_array()){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['case_verdict'] . "</td>";
                                        echo "<td>" . $row['court_procedures'] . "</td>";
        
                                        echo "<td>";
                                            echo "<a href='casesread.php?id=". $row['case_id'] ."' title='View Record' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open' style='color:red'></span></a>";
                                            echo "<a href='updatecases.php?id=". $row['case_id'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil' ></span></a>";
                                            echo "<a href='deletecases.php?id=". $row['case_id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash' style='color:black'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
