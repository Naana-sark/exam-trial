                            ...
                            echo "<table class='table table-bordered table-striped table-responsive-lg'>";
                                ...
                                while($row = $result->fetch_array()){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='individread.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open' style='color:red'></span></a>";
                                            echo "<a href='updateind.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil' ></span></a>";
                                            echo "<a href='deleteind.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash' style='color:black'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
