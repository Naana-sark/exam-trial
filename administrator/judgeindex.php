            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Judge Details</h2>
                        <a href="lawform.php" class="btn btn-info pull-right" target="_blank">Add New Judge</a>
                    </div>
                    <?php
                    //check connection
                            ...
                            echo "<table class='table table-bordered table-striped table-responsive-lg'>";
                                ...
                                while($row = $result->fetch_array()){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='judgeread.php?id=". $row['judge_id'] ."' title='View Record' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open' style='color:red'></span></a>";
                                            echo "<a href='updatejudge.php?id=". $row['judge_id'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil' ></span></a>";
                                            echo "<a href='deletejudge.php?id=". $row['judge_id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash' style='color:black'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
